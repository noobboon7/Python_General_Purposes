...
![An image showing the differences between a firewall, IPS, and IDS.](image.png)
...
![A firewall circled by dashes, protecting the internal network from internet traffic that comes in through the mode.](image-1.png)
...
![An IDS circled above an image of a switch, which rests between a firewall and the network.](image-2.png)
...
![An IPS is situated between a firewall and the internal network.](image-3.png)
...
![Image of the Chronicle dashboard](image-4.png)
